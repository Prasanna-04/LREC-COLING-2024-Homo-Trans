...
model = AutoModelForSequenceClassification.from_pretrained("Jayveersinh-Raj/Gujarati_hatespeech_extension")

## definining where the model weights will be stored
# model_name = "XLMRoberta_Guj"
wts_path = data['model_file']

num_epochs = data['num_epochs']
batch_size = data['batch_size']

train_loader, test_loader, dev_loader = get_loaders("Gujarati")
